...
export default function PageLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="relative z-10 min-h-screen font-sans text-center text-[#0F9D91] overflow-x-hidden">
      ...
      {menuOpen && (
        <div
        className="fixed top-18 right-6 w-72 z-[150] flex flex-col items-start p-4 pt-6 space-y-4 text-white border-5 border-[#3DB8A0] rounded-bl-2xl bg-white/30 backdrop-blur-none"
        >
          <button
            onClick={toggleMenu}
